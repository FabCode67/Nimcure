...
export default function Navbar() {
  ...
  interface IsRouteActive {
    (navPath: string): boolean;
  }

  const isRouteActive: IsRouteActive = (navPath) => {
    ...
    <header className="sticky top-0 z-10 w-full bg-white border-b border-gray-200">
      <div className='max-w-7xl mx-auto flex justify-center'>
        <div className="flex h-16 items-center w-full justify-between px-4">
          <div className="flex items-center">
            <Link href={'/'} className="w-10 h-10 rounded-full bg-green-600 flex items-center justify-center">
              <Image
                src="/mainlogo.png"
                alt="Hospital Logo"
                width={24}
